...
(function (t) {
    ...
    function s() {
        this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
            ...
            nextText: "Next",
            currentText: "Today",
            monthNames: ["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октября", "Ноября", "Декабря"],
            ...
            autoSize: !1,
            disabled: !1
        }, t.extend(this._defaults, this.regional[""]), this.regional.en = t.extend(!0, {}, this.regional[""]), this.regional["en-US"] = t.extend(!0, {}, this.regional.en), this.dpDiv = n(t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'>ghg</div>"))
    }
...
$("#num-phone1").mask("+7(999) 999 99 99");
// phone mask end

// lang select
$(document).mouseup(function (e) {
    var div = $(".localization-lang__select");
    if (!div.is(e.target)
        && div.has(e.target).length === 0) {
        $('.language-select').removeClass('toggle')
    }
});
...
// drop down user profile end

$('.authorized-js').on('click', function () {
    $('.dropdown-menu').show();
});


// trigger additional reservation
$('.trigger-js').on('click', function () {
    $(this).toggleClass('rotate-arrow');
    $('.additionally-list-js').slideToggle();
});
// trigger additional reservation end
...
// datepicker
$('.date-choose-js, .date-choose-withoutDay-js').click(function () {
    $(this).parent().find('.hidden-field, .hidden-field-withoutDay').datepicker('show');
    $('#ui-datepicker-div').prepend('<select name="" id="select-month" class="select-month">\n' +
...
$('#select-month').change(function() {
    ...
    $(this).datepicker({
        onSelect: function (selectedDate) {
            $(this).parent().find('.date-choose-js').html(selectedDate);
        },
        showButtonPanel: true,
        minDate: 0,
        dateFormat: "DD, d MM yy 'год'",
        numberOfMonths: 1,
        firstDay: 1,
        closeText: "Готово",
        autoclose: true,
...
$('.hidden-field-withoutDay').each(function () {

    $(this).datepicker({
        onSelect: function (selectedDate) {
            $(this).parent().find('.date-choose-withoutDay-js').html(selectedDate);
        },
        showButtonPanel: true,
        minDate: 0,
        dateFormat: "d MM yy 'год'",
        numberOfMonths: 1,
        firstDay: 1,
        closeText: "Готово",
        numberOfMonths: 1,
...
// show and scroll cell
$('.table tr:lt(19)').show();

$('.scroll-table--bottom').on('click', function () {
    $('.table tr:lt(19)').hide();
    $('.table tr:gt(11)').show();
    $(this).hide();
    $('.scroll-table--top').css('display', 'flex');
});

$('.scroll-table--top').on('click', function () {
    $('.table tr:lt(19)').show();
    $('.table tr:gt(18)').hide();
    $(this).hide();
    $('.scroll-table--bottom').css('display', 'flex');
});
// show and scroll cell end
